...
expected_outcome: >
  ...
  theirs to work out, asks what would determine it (data, systems, people, what must be true to
  buy), and contains no "N weeks / N months" or "N–M weeks" figure; nothing is written or run.
max_turns: 15
timeout_seconds: 600
allowed_tools: [Read, Skill, Write, Bash]
---

How long will a Senzing POC take?
